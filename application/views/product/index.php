...
<div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="thumbnail_container">
                    <div class="thumbnail thumbnail-center">
                        <img src="<?php echo base_url("assets/img/products/s.jpg") ?>" alt="..." class="img-responsive" id="img-center">
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    ...
    <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
        ...
        <h3>
            Ducabike Clear Clutch Cover for Diavel Monster Multistrada Streetfighter 848 Black Red
        </h3>
            ...
            <div id="container1">
                <div id="col1">
                    <div class="content-col">
                        Product Code : CCDv01DA <br/>
                        Select Quentity : 1 <br/>
                        Select Color : color <br/>
